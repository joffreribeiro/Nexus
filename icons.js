/* ════════════════════════════════════════════════════════════════
   ÍCONES — dicionário único de SVGs de traço (stroke-width 1.6-2)
   usado por fluxo-nav.js e pelos botões/sub-abas que hoje usam emoji.
   Expõe window.NexusIcons; nenhum outro arquivo deve duplicar SVG.
   ════════════════════════════════════════════════════════════════ */
(function () {
    'use strict';
    ...
    window.NexusIcons = {
        ...
        clipboard: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="8" y="2" width="8" height="4" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><line x1="8" y1="11" x2="16" y2="11"/><line x1="8" y1="15" x2="16" y2="15"/></svg>',
        ...
        printer: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg>',
    ...
    // Preenche <... data-icon="chave"></...> com o SVG correspondente — usado
    // em markup estático (index.html) para não duplicar o texto do SVG.
    function mount(root) {
        (root || document).querySelectorAll('[data-icon]').forEach(function (el) {
            var svg = window.NexusIcons[el.getAttribute('data-icon')];
            if (svg && !el.firstElementChild) el.innerHTML = svg;
        });
    }
    window.NexusIcons.mount = mount;
